            ...
            <div className="grid gap-6">
              ...
              <div className="grid gap-6">
                ...
                <div className="grid gap-3">
                  ...
                  <Input id="venture-name" type="text" placeholder="My Venture" required />
                </div>
                <div className="grid gap-3">
                  <Label htmlFor="position-in-venture">Position in Venture</Label>
                  <Input id="position-in-venture" type="text" placeholder="Co-Founder" required />
                </div>
                <div className="grid gap-3">
